...
if TYPE_CHECKING:
    ...
    VLLM_RWKV_SESSION_TTL_SECONDS: float = 1800.0
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Idle RWKV sessions are reclaimed lazily when the engine is active.
    "VLLM_RWKV_SESSION_TTL_SECONDS": lambda: float(
        os.getenv("VLLM_RWKV_SESSION_TTL_SECONDS", "1800")
    ),
